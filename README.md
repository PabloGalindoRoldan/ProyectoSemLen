...
5.- Cuando esté ahí, se meten en github, en el repo, y mandan un pull request para que se mergee todo a develop. Esto nos permite al resto revisar que no haya conflictos. "desarrollo" es nuestra rama principal, ahí vamos a ir avanzando el proyecto pero de a tramos terminados, no mandamos nada roto ni hecho a medias, para eso estan sus ramas particulares. 
